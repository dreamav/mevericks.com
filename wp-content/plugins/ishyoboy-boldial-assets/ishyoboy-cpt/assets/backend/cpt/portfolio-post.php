...
if ( !function_exists('ishyoboy_portfolio_post_type') ){
	function ishyoboy_portfolio_post_type()
	{
		$labels = array(
			...
			'singular_name'     => __( 'Portfolio Item', 'ishyoboy' ),
			'add_new'           => _x( 'Add New Item', 'portfolio-post', 'ishyoboy' ),
			'add_new_item'      => __( 'Add New Item', 'ishyoboy' ),
			'edit_item'         => __( 'Edit Portfolio Item', 'ishyoboy' ),
			'new_item'          => __( 'New Portfolio Item', 'ishyoboy' ),
			'view_item'         => __( 'View Portfolio Item', 'ishyoboy' ),
			'search_items'      => __( 'Search Portfolio Items', 'ishyoboy' ),
			'not_found'         => __( 'No Portfolio Items Found', 'ishyoboy' ),
			'not_found_in_trash'=> __( 'No Portfolio Items Found In Trash', 'ishyoboy' ),
			'parent_item_colon' => __( 'Parent Portfolio Item', 'ishyoboy' ),
			'menu_name'         => __( 'Portfolio', 'ishyoboy' ),
			'all_items'         => __( 'All Portfolio Items', 'ishyoboy' ),
		);
		$taxonomies = array();
		...
		$post_type_args = array(
			...
			'hierarchical'          => false,
			'rewrite'               => array(
				'slug'              => _x( 'portfolio', 'URL slug', 'ishyoboy' ), // "URL slug" is necessary for WPML to be able to translate the slug
				'with_front'        => true,
				'feed'              => true,
				'pages'             => false
			),
...
if ( !function_exists('ishyoboy_portfolio_category') ){
	function ishyoboy_portfolio_category()
	{
		...
		$labels = array(
			'name'                          => __( 'Portfolio Categories', 'ishyoboy' ),
			'singular_name'                 => __( 'Portfolio Category', 'ishyoboy' ),
			'search_items'                  => __( 'Search Portfolio Categories', 'ishyoboy' ),
			'popular_items'                 => __( 'Popular Portfolio Categories', 'ishyoboy' ),
			'all_items'                     => __( 'All Portfolio Categories', 'ishyoboy' ),
			'parent_item'                   => __( 'Parent Portfolio Category', 'ishyoboy' ),
			'edit_item'                     => __( 'Edit Portfolio Category', 'ishyoboy' ),
			'update_item'                   => __( 'Update Portfolio Category', 'ishyoboy' ),
			'add_new_item'                  => __( 'Add New Portfolio Category', 'ishyoboy' ),
			'new_item_name'                 => __( 'New Portfolio Category', 'ishyoboy' ),
			'separate_items_with_commas'    => __( 'Separate Portfolio Categories with commas', 'ishyoboy' ),
			'add_or_remove_items'           => __( 'Add or remove Portfolio Category', 'ishyoboy' ),
			'choose_from_most_used'         => __( 'Choose from most used Portfolio Categories', 'ishyoboy' )
		);

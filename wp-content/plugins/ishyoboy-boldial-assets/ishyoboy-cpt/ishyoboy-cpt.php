<?php
/*
Plugin Name: IshYoBoy CPT
Plugin URI: http://ishyoboy.com/
Description: Enables Custom Post types usage in WordPress Themes by IshYoBoy
Version: 1.0
Author: IshYoBoy
...
if ( ! class_exists( 'Ishyoboy_CPT' ) ) :
	...
	class Ishyoboy_CPT extends Ish_Plugin_Base {
		...
		function add_theme_options_portfolio_options(){
			...
			// PORTFOLIO PAGE ******************************************************************************************
			$of_options[] = array(  'name' => __( 'Portfolio page', 'ish_sc_plugin' ),
				'desc' => __( 'The page which will serve as Portfolio homepage.', 'ish_sc_plugin' ),
			...
			$of_options[] = array(  'name' => __( 'Portfolio Sidebar', 'ishyoboy' ),
				'desc' => __( 'Display Sidebar on Portfolio overview and detail pages.', 'ishyoboy'), //. '<br><br><span style="color: #FF0000;">' . __( '<strong>IMPORTANT:</strong><br>Page breaks and Sections will be removed if a sidebar is added.', 'ishyoboy' ) . '</span>',
			...
			$of_options[] = array(  'name' => __( 'Animation', 'ish_sc_plugin' ),
				'desc' => __( 'Animation style on mouse over.', 'ish_sc_plugin' ),
			...
			$of_options[] = array(  'name' => '', //__( 'Text Animation', 'ish-sc-plugin' ),
				'desc' => __( 'Text animation on mouse over.', 'ish_sc_plugin' ),
			...
			$of_options[] = array(  'name' => '', //__( 'Text Animation', 'ish-sc-plugin' ),
				'desc' => __( 'Direction of the animation on mouse over.', 'ish_sc_plugin' ),
			...
			$of_options[] = array(  'name' => __( 'Display Filter', 'ish-sc-plugin' ),
				'desc' => __( 'Categories buttons for users to filter the items.', 'ish_sc_plugin' ),
				'id' => 'portfolio_filter',
				'std' => '',
				'type' => 'select',
				'options' => Array(
			...
			$of_options[] = array(  'name'  => '', //__( '', 'ish_sc_plugin' ),
				'desc'  => __( 'The title displayed above the filters.', 'ish_sc_plugin' ),
				'id'    => 'portfolio_filter_title',
				'std'   => __( 'Categories', 'ish_sc_plugin' ),
				'type'  => 'text');

			$of_options[] = array(  'name' => __( 'Items Order', 'ish-sc-plugin' ),
				'desc' => __( 'Which Portfolio items to display first.', 'ish_sc_plugin' ),
				'id' => 'portfolio_order',
				'std' => '',
				'type' => 'select',
				'options' => Array(
			...
			$of_options[] = array(  'name' => __( 'Items per page', 'ish-sc-plugin' ),
				'desc' => __( 'Number of items to display per page. Set "-1" to see all.', 'ish_sc_plugin' ),
				'id' => 'portfolio_per_page',
				'std' => '9',
				'type' => 'text');

			$of_options[] = array(  'name' => __( 'Columns Count', 'ish-sc-plugin' ),
				'desc' => __( 'Number of columns to display in the Portfolio Grid', 'ish_sc_plugin' ),
			...
			$of_options[] = array(  'name' => __( 'Masonry Layout', 'ish-sc-plugin' ),
				'desc' => __( 'Display items with different heights and widths.', 'ish_sc_plugin' ),
			...
			$of_options[] = array(  'name' => __( 'Show Categories', 'ish-sc-plugin' ),
				'desc' => __( 'Display item category on mouse over.', 'ish_sc_plugin' ),

...
class Ishyoboy_Dribbble_Widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        ?>
            ...
            <div class="dribbble-widget" data-user-name="<?php echo $widget_username ?>" data-shots-count="<?php echo $widget_postcount ?>"><div class="loader"><?php _e( 'Loading dribbble images...', 'ishyoboy' );?></div></div>
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'postcount' ); ?>"><?php _e('Number of images', 'ishyoboy') ?></label>

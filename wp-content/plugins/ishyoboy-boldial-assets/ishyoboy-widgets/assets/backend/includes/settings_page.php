...
function ishyoboy_twitter_widget_menu() {
	add_options_page( __( 'IshYoBoy Twitter Widget Options', 'ishyoboy' ), __( 'Twitter Options', 'ishyoboy' ), 'manage_options', 'ishyoboy_twitter_widget_settings', 'ishyoboy_twitter_widget_settings_output');
}

function ishyoboy_twitter_widget_settings() {
	$tdf = array();
	$tdf[] = array('name'=>'twitter_widget_consumer_key','label' => __( 'Consumer Key', 'ishyoboy' ) );
	$tdf[] = array('name'=>'twitter_widget_consumer_secret','label'=> __( 'Consumer Secret', 'ishyoboy' ) );
	$tdf[] = array('name'=>'twitter_widget_access_token','label'=> __( 'Access Token', 'ishyoboy' ) );
	$tdf[] = array('name'=>'twitter_widget_access_token_secret', 'label' => __( 'Access Token Secret', 'ishyoboy' ) );
	return $tdf;
}
...
function ishyoboy_twitter_widget_settings_output() {
	...
	echo '<h2>' . __( 'IshYoBoy Twitter Widget Options', 'ishyoboy' ) . '</h2>';

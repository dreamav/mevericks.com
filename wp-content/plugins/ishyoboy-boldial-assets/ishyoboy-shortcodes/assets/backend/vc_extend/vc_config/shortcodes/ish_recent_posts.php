...
vc_map( array(
	'name' => __( 'Recent Blog Posts', 'ish_sc_plugin' ),
	...
	'params' => array_merge(
		...
		array(
			...
			array(
				...
				'description' => __( 'Number of columns to display the posts in.', 'ish_sc_plugin' ),
			),
			array(
				'type' => 'textfield',
				...
				'param_name' => 'count',
				'value' => '4',
				'description' => __( 'Number of posts to display.', 'ish_sc_plugin' ),
			),
			array(
				'type' => 'textfield',
				...
				'param_name' => 'skip',
				'value' => '',
				'description' => __( 'Number of posts to skip.', 'ish_sc_plugin' ),
			),
			array(
				'type' => 'textfield',

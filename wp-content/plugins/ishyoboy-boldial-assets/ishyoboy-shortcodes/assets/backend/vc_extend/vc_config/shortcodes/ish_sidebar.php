...
vc_map( array(
	'name' => __( 'Sidebar', 'ish_sc_plugin' ),
	'base' => 'ish_sidebar',
	'class' => '',
	'show_settings_on_create' => true,
	'category' => Array( __('Content', 'js_composer'), __('IshYoBoy', 'ish_sc_plugin') ),
	'description' => __( 'Widgetized sidebar', 'ish_sc_plugin' ),
	...
	'params' => array_merge(
		array(
			array(
				...
				'description' => __( 'Select the sidebar you previously prepared under Appearance -> Widgets.', 'ish_sc_plugin' )
			),
			array(

...
vc_map( array(
	'name' => __( 'SVG Icon', 'ish_sc_plugin' ),
	'base' => 'ish_svg_icon',
	'class' => '',
	...
	'params' => array_merge(
		array(
			array(
				...
				'param_name' => 'icon',
				'value' => '',
				'description' => __( 'Choose an icon which will be displayed next to the headline.', 'ish_sc_plugin' ). ' ' .
				__( 'To add your own SVG icons add them in a folder inside "ish-plugins/ishyoboy-shortcodes/assets/frontend/images/icon-sets/" in the child theme root.', 'ish_sc_plugin' ),
			),
			array(

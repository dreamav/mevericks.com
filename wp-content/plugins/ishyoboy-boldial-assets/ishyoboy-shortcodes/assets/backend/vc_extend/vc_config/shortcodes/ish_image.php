...
vc_map( array(
	...
	'params' => array_merge(
		array(
			array(
				'type' => 'attach_image',
				'heading' => __( 'Image', 'ish_sc_plugin' ),
				'param_name' => 'image',
				'value' => '',
				'description' => __( 'Select image from media library.', 'ish_sc_plugin' ),
			),
			array(
				'type' => 'ish_buttons_selector_full',
				'heading' => __( 'Image Style', 'ish_sc_plugin' ),
			...
			array(
				'type' => 'ish_buttons_selector_full',
				'heading' => __( 'Stretch to Full-width', 'ish_sc_plugin' ),
				...
				'description' => __( 'Stretch the image to full width if image is smaller than container.', 'ish_sc_plugin' ),
			),
			array(
				'type' => 'dropdown',
				'heading' => __( 'Image Link', 'ish_sc_plugin' ),
			...
			array(
				'type' => 'vc_link',
				'heading' => __( 'Link URL', 'ish_sc_plugin' ),
				'param_name' => 'link_url',
				'value' => '',
				'description' => __( 'URL for the image link.', 'ish_sc_plugin' ),
				'dependency' => Array( 'element' => 'link_type', 'value' => 'custom' ),
			),
			array(
				'type' => 'ish_alignment_selector',
				'heading' => __( 'Image Alignment', 'ish_sc_plugin' ),
				'param_name' => 'align',
			...
			array(
				'type' => 'ish_buttons_selector_full',
				'heading' => __( 'Display Image Caption', 'ish_sc_plugin' ),
				...
				'description' => __( 'Display the image caption if set in its settings.', 'ish_sc_plugin' ),
			),
		),
		$ish_global_params
	),

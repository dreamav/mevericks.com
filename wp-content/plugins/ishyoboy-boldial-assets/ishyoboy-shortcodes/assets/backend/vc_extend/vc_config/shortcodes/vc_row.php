	...
	'params' => array_merge(
		array(
			array(
				...
				'description' => __( 'Adds bottom padding to the row to make it as a standalone section', 'ish_sc_plugin' ),
			),
			array(
				'type' => 'dropdown',
			...
			array(
				...
				'description' => __( 'Adds top decoration to the section.', 'ish_sc_plugin' ),
				'dependency' => Array( 'element' => 'section', 'value' => array('yes')),
			),
			array(
				'type' => 'dropdown',
				...
				'description' => __( 'Adds bottom decoration to the section.', 'ish_sc_plugin' ),
				'dependency' => Array( 'element' => 'section', 'value' => array('yes')),
			),
			array(
				'type' => 'dropdown',
				...
				'description' => __( 'Adds a glow to the background of the section if no background image is used.', 'ish_sc_plugin' ),
				'dependency' => Array( 'element' => 'section', 'value' => array('yes')),
			),
			array(
			...
			array(
				'type' => 'textfield',
				'heading' => __( 'Background Opacity', 'ish_sc_plugin' ),
				'param_name' => 'bg_opacity',
				'value' => '', //__( '100', 'ish_sc_plugin' ),
				'description' => __( 'Number (0 - 100) representing the row opacity in %. 100 - visible, 0 - invisible.', 'ish_sc_plugin' ),
				//'admin_label' => true,
			),
			array(
				'type' => 'attach_image',
			...
			array(
				...
				'description' => __( 'Adds parallax effect to the background image. The "dynamic" uses easing.', 'ish_sc_plugin' ),

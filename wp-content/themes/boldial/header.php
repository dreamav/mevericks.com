...
<!--[if !IE]><!--> <html <?php language_attributes(); ?>><!--<![endif]-->
    ...
    <body <?php body_class( ishyoboy_get_boxed_layout_class() . ' ' . ishyoboy_get_responsive_layout_class() . ' ' . ishyoboy_is_sticky_nav_on() . ' ' . ishyoboy_is_sticky_nav_responsive_on()); ?>>
	    ...
	    <div class="ish-sidenav <?php echo ishyoboy_get_sidenav_position_class(); ?>">
		    ...
		    if ( '' != $main_menu ) {
			    wp_nav_menu( array( 'theme_location' => 'header-menu', 'menu' => $main_menu, 'container' => '', 'menu_id' => 'mainnav', 'menu_class' => 'ish-ph-mn-main_nav', 'fallback_cb' => 'ishyoboy_empty_menu_fallback' ) );
		    }else{
		        wp_nav_menu( array( 'theme_location' => 'header-menu', 'container' => '', 'menu_id' => 'mainnav', 'menu_class' => 'ish-ph-mn-main_nav', 'fallback_cb' => 'ishyoboy_empty_menu_fallback' ) );
		    }
        ...
        <div class="ish-body">
		    ...
		    <div class="ish-wrapper-all">
		        ...
		        <!-- Header part section -->
			    <section class="ish-part_header ish-sticky-scrolling">
				    <div class="ish-row ish-row-notfull">
					    <div class="ish-row_inner">
						    ...
						    <nav class="ish-ph-main_nav">
							    <?php if ( ! ishyoboy_use_sidenav() ) {
							        $main_menu = ishyoboy_get_mainnav_menu();
								    if ( '' != $main_menu ) {
									    wp_nav_menu( array( 'theme_location' => 'header-menu', 'menu' => $main_menu, 'container' => '', 'menu_id' => 'mainnav', 'menu_class' => 'ish-ph-mn-main_nav', 'container_class' => 'ish-ph-mn-center', 'fallback_cb' => 'ishyoboy_empty_menu_fallback' ) );
								    }else{
									    wp_nav_menu( array( 'theme_location' => 'header-menu', 'container' => '', 'menu_id' => 'mainnav', 'menu_class' => 'ish-ph-mn-main_nav', 'container_class' => 'ish-ph-mn-center', 'fallback_cb' => 'ishyoboy_empty_menu_fallback' ) );
								    }

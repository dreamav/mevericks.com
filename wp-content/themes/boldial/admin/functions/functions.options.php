		...
		*/
        ...
        $of_options[] = array(  'name'  => __( 'Pattern Options', 'ishyoboy' ),
            ...
            $of_options[] = array( 	'name' 		=> '',
                                    'desc' 		=>  __( 'Choose one of the pre-defined patterns.', 'ishyoboy' ) . '<br><br><span style="color: #FF0000;">' . __( '<strong>IMPORTANT:</strong><br>The Header background color opacity must not be set to "100".', 'ishyoboy' ) . ' ' . '<a href="#section-header_colors">' . __( 'See setting', 'ishyoboy' ) . '</a>' .  '</span>',
            ...
            $of_options[] = array(  'name' => '',
                                    'desc' => __( 'Upload and select custom pattern.', 'ishyoboy' ) . '<br><br><span style="color: #FF0000;">' . __( '<strong>IMPORTANT:</strong><br>The Header background color opacity must not be set to "100".', 'ishyoboy' ) . ' ' . '<a href="#section-header_colors">' . __( 'See setting', 'ishyoboy' ) . '</a>' .  '</span>',
                                    'id' => 'header_bg_image',
                                    'std' => '',
        ...
        $of_options[] = array(  'name'  => __( 'Font Options', 'ishyoboy' ),
            ...
            $of_options[] = array(  'name' => '', //__( 'Font Variant', 'ishyoboy' ),
                                    ...
                                    'fold' => $id . '_use_google_font',
                                    'type' => 'select',
                                    'options' 	=> ishyoboy_google_variants( ('google' == $ish_fonts[$id]['type']) ? $ish_fonts[$id]['name'] : FONT_2 ) );
            ...
            $of_options[] = array(  'name' => '', //__( 'Font Variant', 'ishyoboy' ),
                                    ...
                                    'fold' => $id . '_use_google_font',
                                    'type' => 'select',
                                    'options' 	=> ishyoboy_google_variants( ('google' == $ish_fonts[$id]['type']) ? $ish_fonts[$id]['name'] : FONT_1 ) );
